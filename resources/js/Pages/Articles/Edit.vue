...
const submit = () => {
    form.post(route('settings.articles.update', props.article.id), {
        _method: 'put'
    });
};
                    ...
                    <CardContent>
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div v-if="article.photo">
                                ...
                                <div class="mt-2">
                                    <img :src="`/storage/${article.photo}`" alt="Foto do artigo" class="h-32 w-32 object-cover rounded">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                />
                                <p class="mt-1 text-sm text-gray-500">Máximo 2MB. Deixe em branco para manter a foto atual.</p>
