<template>
    <Head title="Bem-vindo ao InovGest" />
            ...
            <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-12 text-center">
                    ...
                    <p class="text-xl text-blue-100">
                        Configure a sua conta em apenas 3 passos simples
                    </p>
                </div>
                ...
                <div class="px-8 py-8">
                    ...
                    <div class="grid md:grid-cols-3 gap-6 mb-8">
                        <div class="border-2 border-gray-200 rounded-lg p-6 hover:border-blue-400 transition-colors">
                            ...
                            <p class="text-sm text-gray-600">
                                Configure o logotipo e as cores da sua marca
                            </p>
                        </div>
                        ...
                        <div class="border-2 border-gray-200 rounded-lg p-6 hover:border-blue-400 transition-colors">
                            ...
                            <p class="text-sm text-gray-600">
                                Convide membros da equipa para colaborar
                            </p>
                        </div>
                        ...
                        <div class="border-2 border-gray-200 rounded-lg p-6 hover:border-blue-400 transition-colors">
                            ...
                            <p class="text-sm text-gray-600">
                                Defina papéis e permissões de acesso
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center gap-4">
                        <Link
                            ...
                            class="px-8 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors shadow-md hover:shadow-lg"
                        >
                    ...
                    <div class="mt-8 pt-8 border-t border-gray-200">
                        <div class="grid grid-cols-3 gap-4 text-center">
                            ...
                            <div>
                                <div class="text-3xl font-bold text-gray-900">
                                    {{ Math.ceil((progress.total_tasks - progress.completed_tasks) * 2) }}
                                </div>
                                <div class="text-sm text-gray-600 mt-1">
                                    Minutos Estimados
                                </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="#" class="text-blue-600 hover:underline font-medium">
                        Consulte o nosso guia de início rápido
                    </a>
                </p>
            </div>
        </div>
