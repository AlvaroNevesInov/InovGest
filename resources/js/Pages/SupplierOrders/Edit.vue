...
const form = useForm({
    order_date: props.supplierOrder.order_date,
    supplier_id: props.supplierOrder.supplier_id,
    notes: props.supplierOrder.notes || '',
    lines: props.supplierOrder.lines.map(line => ({
...
const submit = () => {
    form.put(route('supplier-orders.update', props.supplierOrder.id));
};
</script>

<template>
    <Head title="Editar Encomenda a Fornecedor" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                    Editar Encomenda a Fornecedor #{{ supplierOrder.number }}
                </h2>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex items-center justify-end gap-4">
                        ...
                        <Button type="submit" :disabled="form.processing || form.lines.length === 0">
                            {{ form.processing ? 'A guardar...' : 'Atualizar Encomenda' }}
                        </Button>
                    </div>
                </form>
            </div>
